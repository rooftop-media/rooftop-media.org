...
// let tokens = markup_to_tokens(`<html>Hello! This is some html! <a href="link.com" target="_blank">Link!</a></html>Text at the end! This is valid!`);
// let tokens = markup_to_tokens(`<tag><"This whole string is now valid, because you can't have "<" followed by '"'.  No highlighting here </tag>`);
let tokens = markup_to_tokens(`<div style="color:pink;" alt="hi">This is valid, and will be kept!</div>
...
let tags = parse_to_tags(parsed);
let valid_tags = tags_to_valid_tags(tags);
let html = tags_to_html(valid_tags);
console.log(html);